...
<div id="bannersCarousel" class="carousel slide mb-5 d-none d-md-block" data-ride="carousel">
    <div class="carousel-inner">
        <div class="carousel-item active">
            <a href="#">
                <img src="{{ url('images/banner_provisorio1.png') }}" class="w-100" alt="">
            </a>
        </div>
        <div class="carousel-item">
            <a href="#">
                <img src="{{ url('images/banner_provisorio2.png') }}" class="w-100" alt="">
            </a>
        </div>
        <div class="carousel-item">
            <a href="#">
                <img src="{{ url('images/banner_provisorio3.png') }}" class="w-100" alt="">
            </a>
        </div>
        <div class="carousel-item">
            <a href="#">
                <img src="{{ url('images/banner_provisorio4.png') }}" class="w-100" alt="">
            </a>
        </div>
    </div>
